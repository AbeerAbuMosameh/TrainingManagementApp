        ...
        <div class="login-content flex-column-fluid d-flex flex-column p-10">
            ...
            <div class="text-right d-flex justify-content-center">
                <div class="top-signup text-right d-flex justify-content-end pt-5 pb-lg-0 pb-10">
                    <div class="text-muted font-weight-bold font-size-h4">Create Advisor Account?
                    ...
                    <form class="form" action="{{route('trainees.store')}}"
                        ...
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="pb-10 pb-lg-15">
                                <h3 class="font-weight-bolder text-dark display5">Create Trainee Account</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6"
                                               name="gpa" id="gpa" placeholder="Enter Your last qualification GPA"/>
                                    </div>
                                    <!--end::Input-->
                                </div>
                            </div>
...
<script>
    ...
    const paymentDiv = document.querySelector('#payment_output');
    ...
    gpaInput.addEventListener('input', updateGPA);
    ...
    function updateGPA() {
        gpaOutput.textContent = 'GPA : ' + gpaInput.value;
    }
    ...
    paymentSelect.addEventListener('change', () => {
        paymentDiv.textContent = 'Preferred Payment Method : ' + paymentSelect.value;
    });
