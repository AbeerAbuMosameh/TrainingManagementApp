				...
				<div class="login-aside d-flex flex-column flex-row-auto">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<a href="#" class="login-logo text-center pt-lg-25 pb-10">
							<img src="{{asset('admin/assets/media/logos/logo-1.png')}}" class="max-h-70px" alt="" />
						</a>
						<!--end::Aside header-->
						<!--begin::Aside Title-->
						...
						<div class="login-form">
                            ...
                            <form  class="form" id="kt_login_singin_form" method="POST" action="{{ route('login') }}">
								...
								<div class="pb-5 pb-lg-15">
									...
									<a href="{{route('login')}}" class="text-primary font-weight-bolder">Create Account</a></div>
								</div>
								<!--begin::Title-->
								<!--begin::Form group-->
								...
								<div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										...
										<a href="{{route('forget')}}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Forgot Password ?</a>
									</div>
